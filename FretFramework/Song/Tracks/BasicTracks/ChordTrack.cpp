...
template<>
void BasicTrack<Chord<5>>::convertNotesToMid(MidiFile::MidiChunk_Track& events) const
{
...
template<>
void BasicTrack<Chord<6>>::convertNotesToMid(MidiFile::MidiChunk_Track& events) const
{
	uint32_t sliderNotes = UINT32_MAX;
